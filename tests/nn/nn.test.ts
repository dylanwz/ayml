...
function testMNIST() {
  const network = nn.buildNetwork([784, 30, 10], fn.Activations.RELU, fn.Activations.SIGMOID);
  ...
  // achieved 70-90% with [784, 30, 10], 3.0 lr, epoch 10
}
